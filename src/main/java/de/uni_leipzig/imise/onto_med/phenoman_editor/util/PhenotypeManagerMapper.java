...
public class PhenotypeManagerMapper {
  ...
  /**
   * This method will add the provided {@see org.smith.phenoman.model.phenotype.top_level.Entity} to
   * the {@link PhenotypeManager}.
   *
   * @param entity the {@link Entity}.
   * @throws WrongPhenotypeTypeException If the specified {@link AbstractPhenotype} of the {@link
   *     Entity} does not exist.
   */
  public void writeToOntology(@Nonnull Entity entity) throws WrongPhenotypeTypeException {
  ...
  public @Nonnull Entity buildEntity(@Nonnull PhenotypeBean data)
    ...
    if (EntityType.CATEGORY.equals(data.getType())) {
      ...
      throw new UnsupportedDataTypeException(
          "The provided phenotype data has an invalid datatype.");
    }

    entity.setOID(data.getOid());
    data.getTitles()
        .forEach(t -> entity.addTitle(new Title(t.getString(), t.getLocale().toLanguageTag())));
    data.getSynonyms().forEach(s -> entity.addLabel(s.getString(), s.getLocale().toLanguageTag()));
    data.getDescriptions()
        .forEach(d -> entity.addDescription(d.getString(), d.getLocale().toLanguageTag()));
  ...
  private @Nonnull RestrictedPhenotype buildRestrictedPhenotype(@Nonnull PhenotypeBean data)
      throws UnsupportedDataTypeException {
    ...
    if (EntityType.RESTRICTED_SINGLE_PHENOTYPE.equals(data.getType())) {
      ...
      throw new UnsupportedDataTypeException(
          String.format(
              "The provided phenotype data has an invalid datatype %s.", data.getDatatype()));
    }
  ...
  private @Nonnull AbstractSinglePhenotype buildAbstractSinglePhenotype(@Nonnull PhenotypeBean data)
      throws UnsupportedDataTypeException {
    AbstractSinglePhenotype entity;

    if (OWL2Datatype.XSD_DECIMAL.equals(data.getDatatype())) {
      entity =
          new AbstractSingleDecimalPhenotype(
              data.getId(), data.getMainTitle(), data.getSuperCategories().toArray(new String[0]));
    } else if (OWL2Datatype.XSD_DATE_TIME.equals(data.getDatatype())) {
      entity =
          new AbstractSingleDatePhenotype(
              data.getId(), data.getMainTitle(), data.getSuperCategories().toArray(new String[0]));
    } else if (OWL2Datatype.XSD_BOOLEAN.equals(data.getDatatype())) {
      entity =
          new AbstractSingleBooleanPhenotype(
              data.getId(), data.getMainTitle(), data.getSuperCategories().toArray(new String[0]));
    } else {
      throw new UnsupportedDataTypeException(
          String.format(
  ...
  private @Nonnull AbstractCalculationPhenotype buildAbstractCalculationPhenotype(
      @Nonnull PhenotypeBean data) throws UnsupportedDataTypeException {
    AbstractCalculationPhenotype entity;

    if (OWL2Datatype.XSD_DECIMAL.equals(data.getDatatype())) {
      entity =
          new AbstractCalculationDecimalPhenotype(
              data.getId(),
              data.getMainTitle(),
      ...
      entity =
          new AbstractCalculationDatePhenotype(
              data.getId(),
              data.getMainTitle(),
              model.getFormula(data.getFormula()),
              data.getSuperCategories().toArray(new String[0]));
      ...
      entity =
          new AbstractCalculationBooleanPhenotype(
              data.getId(),
              data.getMainTitle(),
              model.getFormula(data.getFormula()),
              data.getSuperCategories().toArray(new String[0]));
  ...
  private @Nonnull AbstractBooleanPhenotype buildAbstractBooleanPhenotype(
      @Nonnull PhenotypeBean data) {
    AbstractBooleanPhenotype entity =
        new AbstractBooleanPhenotype(
            data.getId(), data.getMainTitle(), data.getSuperCategories().toArray(new String[0]));
    entity.setMainResult(data.getMainResult());
  ...
  private @Nonnull RestrictedSinglePhenotype buildRestrictedSinglePhenotype(
      @Nonnull PhenotypeBean data) throws UnsupportedDataTypeException {
    AbstractSinglePhenotype parent =
        model.getReader().getAbstractSinglePhenotype(data.getSuperPhenotype());
    RestrictedSinglePhenotype entity;

    if (parent.hasBooleanDatatype()) {
      entity =
          parent
              .asAbstractSingleBooleanPhenotype()
              .createRestrictedPhenotype(
                  data.getId(),
                  data.getMainTitle(),
      ...
      entity =
          parent
              .asAbstractSingleDecimalPhenotype()
              .createRestrictedPhenotype(
                  data.getId(),
                  data.getMainTitle(),
  ...
  private @Nonnull RestrictedCalculationPhenotype buildRestrictedCalculationPhenotype(
      @Nonnull PhenotypeBean data) throws UnsupportedDataTypeException {
    AbstractCalculationPhenotype parent =
        model.getReader().getAbstractCalculationPhenotype(data.getSuperPhenotype());
    RestrictedCalculationPhenotype entity;

    if (parent.hasBooleanDatatype()) {
      entity =
          parent
              .asAbstractCalculationBooleanPhenotype()
              .createRestrictedPhenotype(
                  data.getId(),
                  data.getMainTitle(),
                  data.getRestriction().asBooleanRange(),
      ...
      entity =
          parent
              .asAbstractCalculationDatePhenotype()
              .createRestrictedPhenotype(
                  data.getId(),
                  data.getMainTitle(),
                  data.getRestriction().asDateRange(),
      ...
      entity =
          parent
              .asAbstractCalculationDecimalPhenotype()
              .createRestrictedPhenotype(
                  data.getId(),
                  data.getMainTitle(),
                  data.getRestriction().asDecimalRange(),
  ...
  private @Nonnull RestrictedBooleanPhenotype buildRestrictedBooleanPhenotype(
      @Nonnull PhenotypeBean data) {
    AbstractBooleanPhenotype parent =
        model.getReader().getAbstractBooleanPhenotype(data.getSuperPhenotype());

    RestrictedBooleanPhenotype entity =
        parent.createRestrictedPhenotype(
            data.getId(),
            data.getMainTitle(),
  ...
  public @Nonnull PhenotypeBean loadEntity(@Nonnull Entity entity) {
    ...
    return bean.setType(EntityType.getEntityType(entity))
  ...
  private @Nonnull PhenotypeBean loadCategoryAttributes(@Nonnull Category entity) {
    return new PhenotypeBean().setSuperCategories(entity.getSuperCategoriesOrEmptyList());
  }
  ...
  private @Nonnull PhenotypeBean loadAbstractAttributes(@Nonnull AbstractPhenotype entity) {
    ...
    return bean.setExclusionCriterion(entity.isExclusionCriterion())
        .setSuperCategories(Arrays.asList(entity.getCategories()));
  }

  private @Nonnull PhenotypeBean loadAbstractSingleAttributes(
  ...
  private @Nonnull PhenotypeBean loadAbstractCalculationAttributes(
      @Nonnull AbstractCalculationPhenotype entity) {
    return new PhenotypeBean()
  ...
  private @Nonnull PhenotypeBean loadAbstractBooleanAttributes(
      @Nonnull AbstractBooleanPhenotype entity) {
    return new PhenotypeBean().setMainResult(entity.isMainResult());
  }
  ...
  private @Nonnull PhenotypeBean loadResctrictedAttributes(@Nonnull RestrictedPhenotype entity) {
    ...
    return bean.setSuperPhenotype(entity.getAbstractPhenotypeName()).setScore(entity.getScore());
  }

  private @Nonnull PhenotypeBean loadRestrictedSingleAttributes(
      @Nonnull RestrictedSinglePhenotype entity) {
    return new PhenotypeBean()
        .setDatatype(entity.getDatatype())
  ...
  private @Nonnull PhenotypeBean loadRestrictedCalculationAttributes(
      @Nonnull RestrictedCalculationPhenotype entity) {
    return new PhenotypeBean()
        .setDatatype(entity.getDatatype())
        .setRestriction(entity.getPhenotypeRange())
        .setNegated(entity.isNegated());
  ...
  private @Nonnull PhenotypeBean loadRestrictedBooleanAttributes(
      @Nonnull RestrictedBooleanPhenotype entity) {
    return new PhenotypeBean().setFormula(entity.getFormula()).setMainResult(entity.isMainResult());
  }
  ...
  private List<LocalizedString> stringMapToLocalizedStringList(Map<String, Set<String>> map) {
    ...
    map.forEach(
        (lang, list) ->
            list.forEach(
                text -> stringList.add(new LocalizedString(text, Locale.forLanguageTag(lang)))));
    return stringList;
  }
