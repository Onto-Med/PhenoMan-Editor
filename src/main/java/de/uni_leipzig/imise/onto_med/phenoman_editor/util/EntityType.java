...
public enum EntityType {
  ...
  public boolean isAbstractPhenotype() {
    return equals(ABSTRACT_SINGLE_PHENOTYPE)
        || equals(ABSTRACT_CALCULATION_PHENOTYPE)
        || equals(ABSTRACT_BOOLEAN_PHENOTYPE);
  }

  public boolean isRestrictedPhenotype() {
    return equals(RESTRICTED_SINGLE_PHENOTYPE)
        || equals(RESTRICTED_CALCULATION_PHENOTYPE)
        || equals(RESTRICTED_BOOLEAN_PHENOTYPE);
  }
