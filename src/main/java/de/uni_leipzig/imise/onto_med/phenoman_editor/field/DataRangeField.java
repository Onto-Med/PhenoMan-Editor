    ...
    if (minField.getValue() != null && minOperatorComboBox.getSelectedItem() != null)
      range.setLimit(
          Objects.requireNonNull(
              OWLFacet.getFacetBySymbolicName((String) minOperatorComboBox.getSelectedItem())),
          String.valueOf(minField.getValue()));
    if (maxField.getValue() != null && maxOperatorComboBox.getSelectedItem() != null)
      range.setLimit(
          Objects.requireNonNull(
              OWLFacet.getFacetBySymbolicName((String) maxOperatorComboBox.getSelectedItem())),
